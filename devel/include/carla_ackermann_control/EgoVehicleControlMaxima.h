...
bool operator==(const ::carla_ackermann_control::EgoVehicleControlMaxima_<ContainerAllocator1> & lhs, const ::carla_ackermann_control::EgoVehicleControlMaxima_<ContainerAllocator2> & rhs)
{
