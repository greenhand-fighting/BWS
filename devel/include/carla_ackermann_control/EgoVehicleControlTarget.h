...
bool operator==(const ::carla_ackermann_control::EgoVehicleControlTarget_<ContainerAllocator1> & lhs, const ::carla_ackermann_control::EgoVehicleControlTarget_<ContainerAllocator2> & rhs)
{
