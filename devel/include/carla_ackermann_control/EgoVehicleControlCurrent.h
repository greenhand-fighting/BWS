...
bool operator==(const ::carla_ackermann_control::EgoVehicleControlCurrent_<ContainerAllocator1> & lhs, const ::carla_ackermann_control::EgoVehicleControlCurrent_<ContainerAllocator2> & rhs)
{
