...
bool operator==(const ::carla_ackermann_control::EgoVehicleControlStatus_<ContainerAllocator1> & lhs, const ::carla_ackermann_control::EgoVehicleControlStatus_<ContainerAllocator2> & rhs)
{
