...
class EgoVehicleControlInfo(genpy.Message):
  ...
  _type = "carla_ackermann_control/EgoVehicleControlInfo"
...
"""
  ...
  _slot_types = ['std_msgs/Header','carla_ackermann_control/EgoVehicleControlMaxima','carla_ackermann_control/EgoVehicleControlTarget','carla_ackermann_control/EgoVehicleControlCurrent','carla_ackermann_control/EgoVehicleControlStatus','carla_msgs/CarlaEgoVehicleControl']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.restrictions is None:
        self.restrictions = carla_ackermann_control.msg.EgoVehicleControlMaxima()
      if self.target is None:
        self.target = carla_ackermann_control.msg.EgoVehicleControlTarget()
      if self.current is None:
        self.current = carla_ackermann_control.msg.EgoVehicleControlCurrent()
      if self.status is None:
        self.status = carla_ackermann_control.msg.EgoVehicleControlStatus()
